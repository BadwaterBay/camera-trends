<!-- Header -->
<header id="masthead-image" class="masthead lozad
<?php
        ...
        <div class="col-12 mx-auto col-xl-10">
          <?php 
            if (!defined('HEADER_TYPE') || HEADER_TYPE=='site') {
              ...
              echo '">',"\r\n",
              '<h1>',SITE_TITLE,'</h1>',"\r\n",
              '<div class="subheading">',SITE_SUBTITLE,'</div>',"\r\n";
            }
            elseif (HEADER_TYPE=='blogpost') {
              echo '<div class="post-heading">',"\r\n",
              '<h1>',SITE_TITLE,'</h1>',"\r\n",
              '<h2 class="subheading">',SITE_SUBTITLE,'</h2>',"\r\n",
              '<div class="meta">',SITE_SUBSUBTITLE,'</div>',"\r\n";
            }
          ?>
          </div>
        </div>
